...
class _FakerApi implements FakerApi {
  _FakerApi(
    this._dio, {
    this.baseUrl,
  }) {
  ...
  Future<PeopleEntityResponse> getPeople(
    ...
    final queryParameters = <String, dynamic>{
      r'_quantity': quantity,
      r'_gender': gender,
      r'_birthday_start': birthdayStart,
    };
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<PeopleEntityResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = PeopleEntityResponse.fromJson(_result.data!);
    return value;
  }
